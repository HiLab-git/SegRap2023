...
def random_split_dataset(base, input_file):
    random.seed(2023)
    input_file = '{}/{}'.format(base, input_file)
    train_names_file = base + '/image_train.csv'
    valid_names_file = base + '/image_valid.csv'
    test_names_file  = base + '/image_test.csv'
...
if __name__ == "__main__":
    # create cvs file for SegRap2023
    # set data_dir based on your own system
    data_dir    = 'data_dir/Task001_OARs_preprocess'
    ...
    random_split_dataset(base, output_file)

    # obtain ground truth and segmentation pairs for evaluation
    test_csv    = base + "/image_test.csv"
    gt_seg_csv  = base + "/image_test_gt_seg.csv"
