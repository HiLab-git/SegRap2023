...
docker volume create segrap2023_gtv_segmentationcontainer-output-$VOLUME_SUFFIX
...
docker run --rm --gpus all \
        ...
        segrap2023_gtv_segmentationcontainer
...
docker volume rm segrap2023_gtv_segmentationcontainer-output-$VOLUME_SUFFIX
